...
// GameCard와 같은 모양: 16:9 썸네일 · 제목 heading3 22px + 배지 21px · 룰 body2 21px · 일정 줄 21px · GM 아바타 24px.
export function GameListSkeleton() {
  return (
    <VStack className="gap-2.5">
      {Array.from({ length: 3 }).map((_, i) => (
        <div key={i} className="overflow-hidden rounded-[14px] border border-gray-200">
