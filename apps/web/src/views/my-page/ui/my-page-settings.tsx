  ...
  return (
    <section className="flex flex-col gap-2.5">
      ...
      <div className={MY_PAGE_GROUP_CLASS}>
        <div className="flex h-[52px] items-center gap-3 border-b border-gray-100 px-3.5">
          <Text typography="subtitle1" className="flex-1">
            화면 테마
          </Text>
          <ThemeSetting />
        </div>
        <SignOutButton className="h-[52px] w-full justify-between rounded-none border-0 px-3.5 text-subtitle1 font-bold text-gray-900">
          로그아웃
          {handleLabel && (
