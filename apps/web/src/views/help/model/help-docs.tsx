...
export type HelpBlock =
  ...
  | { kind: typeof HELP_BLOCK.note; body: ReactNode };
...
export const HELP_DOCS: HelpDoc[] = [
        ...
        steps: [
          {
            ...
            body: (
              <>
                구인 목록 탭에서 배지가 모집 중인 글만 신청을 받습니다.
                <br />
          ...
          },
          {
            ...
            body: (
              <>
                게임 종류, 예상 플레이 시간, 정원이 상세 위쪽에 있습니다.
                <br />
    ...
    blocks: [
      {
        ...
        steps: [
          ...
          },
          {
            ...
            body: (
              <>
                정원을 정하고 선착순과 추첨 중 선정 방식을 지정합니다.
                <br />
            ...
            note: (
              <>
                등록 뒤에 고칠 수 있는 것은 제목·소개·이미지·정원입니다.
                <br />
  ...
  },
  {
    ...
    lead: (
      <>
        신청이 모이면 구인 상세 아래 "운영 관리"로 들어갑니다.
        <br />
    ...
    blocks: [
      {
        ...
        steps: [
          ...
          },
          {
            ...
            body: (
              <>
                확정된 사람에게 조율 격자가 열립니다.
                <br />
                아직 칠하지 않은 사람은 참여자 관리 화면의
                <br />
                확정 명단에서 바로 보입니다.
              </>
            ),
          },
          {
            ...
            note: (
              <>
                확정 뒤에 인원이 빠지면 대기자를 올려 다시 채울 수 있습니다.
                <br />
                일정은 그대로 두고 사람만 바뀝니다.
              </>
            ),
    ...
    blocks: [
      {
        ...
        steps: [
          ...
          },
          {
            ...
            body: (
              <>
                디스코드·X·인스타그램·블루스카이·유튜브·스프레드시트·드라이브·노션은
                <br />
                브랜드 마크가 자동으로 붙습니다.
                <br />
