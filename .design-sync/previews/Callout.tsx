...
export const TintedPalette = () => (
  <VStack gap="100">
    ...
    <Callout.Root colorPalette="primary">
      <Callout.Description>
        확정 참여자 3명에게 디스코드로 같은 안내가 전해집니다.
      </Callout.Description>
    </Callout.Root>
    <Callout.Root colorPalette="success">
      <Callout.Description>
        출석을 확정했습니다. 30일 안에는 다시 고칠 수 있습니다.
      </Callout.Description>
    </Callout.Root>
    ...
    <Callout.Root colorPalette="notice">
      <Callout.Description>
        확인 방식이 바뀌었습니다. GM이 직접 확정하는 절차가 추가됐습니다.
      </Callout.Description>
    </Callout.Root>
...
export const DeadlineAction = () => (
  <Callout.Root colorPalette="warning">
    ...
    <Callout.Description>
      정원이 아직 안 찼습니다. 지금 추첨하면 모집이 바로 닫힙니다.
    </Callout.Description>
    <Callout.Action>
