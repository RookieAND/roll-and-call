...
export const Default = () => (
  <VStack gap="075">
    <Text typography="body4" foreground="hint">모집 인원</Text>
...
export const Invalid = () => (
  <VStack gap="075">
    <Text typography="body4" foreground="hint">모집 인원 (최소 인원 미만)</Text>
...
export const Boundaries = () => (
  <VStack gap="150">
    <VStack gap="075">
      <Text typography="body4" foreground="hint">최소값 (감소 버튼 비활성)</Text>
      <Stepper value={1} min={1} max={8} onChange={() => {}} aria-label="최소 인원" />
    </VStack>
    <VStack gap="075">
      <Text typography="body4" foreground="hint">최대값 (증가 버튼 비활성)</Text>
...
export const Disabled = () => (
  <VStack gap="075">
    <Text typography="body4" foreground="hint">확정된 모집 인원</Text>
