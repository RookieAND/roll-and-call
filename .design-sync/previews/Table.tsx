  ...
  <Table.Root>
    <Table.Header>
      <Table.Row>
        ...
        <Table.Head align="end" numeric>정원</Table.Head>
      </Table.Row>
    </Table.Header>
    <Table.Body>
      <Table.Row>
        ...
        <Table.Cell><Badge colorPalette="success">확정</Badge></Table.Cell>
        <Table.Cell align="end" numeric>1/1</Table.Cell>
      </Table.Row>
      <Table.Row>
        <Table.Cell>새벽</Table.Cell>
        <Table.Cell>PL</Table.Cell>
        <Table.Cell><Badge colorPalette="success">확정</Badge></Table.Cell>
        <Table.Cell align="end" numeric>4/6</Table.Cell>
      </Table.Row>
      <Table.Row>
        <Table.Cell>파도</Table.Cell>
        <Table.Cell>PL</Table.Cell>
        <Table.Cell><Badge>대기</Badge></Table.Cell>
        <Table.Cell align="end" numeric>4/6</Table.Cell>
      </Table.Row>
    </Table.Body>
  </Table.Root>
  ...
  <Table.Root size="sm">
    ...
    <Table.Body>
      ...
      <Table.Row>
        ...
        <Table.Cell><Badge colorPalette="warning">마감 임박</Badge></Table.Cell>
      </Table.Row>
    </Table.Body>
  ...
  <Table.Root>
    <Table.Header>
      <Table.Row>
        ...
        <Table.Head align="end" numeric>신청 인원</Table.Head>
      </Table.Row>
    </Table.Header>
    <Table.Body>
      <Table.Row interactive>
        <Table.Cell>크툴루의 부름 단편</Table.Cell>
        <Table.Cell>달빛</Table.Cell>
        <Table.Cell align="end" numeric>8명</Table.Cell>
      </Table.Row>
      <Table.Row interactive>
        <Table.Cell>디아스포라 3화</Table.Cell>
        <Table.Cell>새벽</Table.Cell>
        <Table.Cell align="end" numeric>5명</Table.Cell>
      </Table.Row>
    </Table.Body>
  </Table.Root>
);
