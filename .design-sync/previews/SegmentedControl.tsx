...
export const AttendanceAnswer = () => (
  <VStack gap="150">
    <SegmentedControl.Root value="present" onValueChange={() => {}} aria-label="참석 여부">
      <SegmentedControl.Item value="present" colorPalette="success">참석</SegmentedControl.Item>
      <SegmentedControl.Item value="absent" colorPalette="danger">불참</SegmentedControl.Item>
    </SegmentedControl.Root>
