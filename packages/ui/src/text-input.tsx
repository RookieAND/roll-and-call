...
export type TextInputProps = ComponentPropsWithRef<"input"> & VariantProps<typeof field>;
...
export type TextareaProps = ComponentPropsWithRef<"textarea"> & VariantProps<typeof field>;

export function Textarea({ invalid, className, ...props }: TextareaProps) {
  return <textarea className={cn(field({ invalid }), "min-h-24 py-2.5", className)} {...props} />;
}
