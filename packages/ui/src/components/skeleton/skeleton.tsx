...
const skeleton = cva(
  "animate-[shimmer_1.3s_ease-in-out_infinite] bg-gray-100 motion-reduce:animate-none",
  {
    variants: {
      rounded: {
        none: "rounded-none",
...
type SkeletonState = VariantProps<typeof skeleton>;

export interface SkeletonProps extends StateProps<SkeletonState>, SkeletonState {
  width?: Size;
  height?: Size;
}
