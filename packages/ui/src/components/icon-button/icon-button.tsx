...
const iconButton = cva(
  "inline-flex shrink-0 items-center justify-center whitespace-nowrap rounded-200 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
